...
$columns = [
	[
		...
		'checkboxOptions' => function ($model, $key, $index, $column) {
			return ['value' => $key, 'label' => '<span></span>', 'labelOptions' => ['class' => 'mt-checkbox mt-checkbox-outline', 'style' => 'padding-left:30px;']];
		},
	],
	[
		'header' => 'ID',
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">Tree分类管理</span>
                </div>
                <div class="actions">
...
jQuery(document).ready(function() {
    highlight_subnav('goods-cat/index'); //子导航高亮
    ...
    $("#tree_3").jstree({
        ...
        "core" : {
            ...
            "check_callback" : true,
            'data': {
                "url" : "<?=Url::toRoute('/goods-cat/tree');?>",
                "dataType" : "json"
            }
            /*'data': [
                {
