...
use \common\modelsgii\OrderRenshi;

/**
 * OrderRenshiSearch represents the model behind the search form of `backend\models\OrderRenshi`.
 */
class OrderRenshiSearch extends OrderRenshi {
	/**
	 * @inheritdoc
	 */
